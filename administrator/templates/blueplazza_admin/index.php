...
<link rel="stylesheet" href="templates/blueplazza_admin/css/template_css.css" type="text/css" />
<link rel="stylesheet" href="templates/blueplazza_admin/css/theme.css" type="text/css" />
...
<div id="wrapper">
	<div id="header">
			<div id="joomla"><img src="templates/blueplazza_admin/images/header_text.png" alt="Joomla! Logo" /></div>
	</div>
</div>
...
<tr>
	...
	<td class="menubackgr2" align="right" style="color:#FFFFFF; " >
		<div id="wrapper1" >
			<?php mosLoadAdminModules( 'header', 2 );?>
		</div>
	</td>
	<td class="menubackgr2" align="right" style="padding-right:5px;">
		<a href="index2.php?option=logout" style="color: #ffffff; font-weight: bold">
			Logout</a>
