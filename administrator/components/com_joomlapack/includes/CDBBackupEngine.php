 ...
 *
 * Takes care of backing up the database contents to one or several SQL files
 *
 * @version $Id$
 * @copyright 2006-2007 Nicholas K. Dionysopoulos <nikosdion@gmail.com>
 *
 * LICENSE: This source file is distributed subject to the GNU General Public
 * Licence (GPL) version 2.
 * http://www.gnu.org/copyleft/gpl.html
 * If you did not receive a copy of the GNU GPL and are unable to obtain it
 * through the web, please send a note to nikosdion@gmail.com so we can mail you
 * a copy immediately.
 *
...
class CDBBackupEngine {
	...
	function CDBBackupEngine( $onlyDBDumpMode = false ){
		...
		// Detect JoomFish
		if (file_exists(JPSiteRoot . '/administrator/components
