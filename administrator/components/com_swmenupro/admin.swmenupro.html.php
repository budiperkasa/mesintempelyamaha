...
class HTML_swmenupro
{
	function editCSS($id,  &$content,$limit, $limitstart,$menu ) {
		...
		$css_path =	$mosConfig_absolute_path . '/modules/mod_swmenupro/styles/menu'.$id.'.css';
	?>
	...
	setTimeout('form.action="index2.php"',300);
...
?>
  ...
  <input id="rel_path" name="rel_path" type="hidden" value="<?php echo $mosConfig_live_site; ?>" />
...
function doSystemPopup(){
	window.open('components/com_swmenupro/menu_systems.php', 'win1', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=760,height=550,directories=no,location=no');
}
...
function doPreviewWindow(id) {
	...
	setTimeout('form.action="index2.php"',300);
	setTimeout('form.no_html.value=0',300);
	setTimeout('form.task.value=0',300);
}
...
<table align="left" cellpadding="4" cellspacing="4" border="0" width="750">
 ...
 <ul>
 <li>
 <a href="index2.php?option=com_swmenupro&task=upgrade" ><?php echo _SW_UPGRADE_LINK; ?></a>
 </li>
 </ul>
 </td>
 </tr>
...
<tr><td width="520" valign="top">
  ...
  <table cellpadding="2" cellspacing="0" border="0" width="100%" align="left"> 
     <tr><td colspan="5" class="swmenu_tabheading"># <?php echo _SW_MENU_MODULES; ?></td> <td colspan="3" align="right" class="swmenu_tabheading" style="text-align:right;">
     <?php echo _SW_DISPLAY; ?> #<?php echo $pageNav->writeLimitBox(); ?><td>
      </tr>
      <?php
	...
	?> 
      <tr class="swmenu_row<?PHP echo $k; ?>"> 
        ...
        if(file_exists($mosConfig_absolute_path."/modules/mod_swmenupro/styles/menu".$row->id.".css")){
...
?> 
<tr> 
      <td class="swmenu_tabheading" align="center" colspan="8" style="text-align:center;"> <?php echo $pageNav->writePagesLinks(); ?></td> 
 </tr> 
     <tr> 
       <td align="center" colspan="8" class="swmenu_menubackgr"> <?php echo $pageNav->writePagesCounter(); ?></td> 
      </tr> 
    </table> 
...
<?php
    ...
    <table cellpadding="4" cellspacing="0" border="0" align="center" width="100%"> 
      <tr> 
		...
		<img src="components/com_swmenupro/images/swmenupro_footer.png" alt="swmenupro.com" border="0"/>
		</a><br/> swMenuPro &copy;2007 by Sean White<br />
	...
	<td>
	 <table align="center">
	  <tr>
	    ...
	    <td>/modules/mod_swmenupro</td><td><?php echo is_writable($mosConfig_absolute_path."/modules/mod_swmenupro") ? '<font color="green">'._SW_WRITABLE.'</font>' : '<font color="red">'._SW_UNWRITABLE.'</font>' ?></td>
	  </tr><tr>
	    <td>/modules/mod_swmenupro/images</td><td><?php echo is_writable($mosConfig_absolute_path."/modules/mod_swmenupro/images") ? '<font color="green">'._SW_WRITABLE.'</font>' : '<font color="red">'._SW_UNWRITABLE.'</font>' ?></td>
	  </tr><tr>
	    <td>/modules/mod_swmenupro/styles</td><td><?php echo is_writable($mosConfig_absolute_path."/modules/mod_swmenupro/styles") ? '<font color="green">'._SW_WRITABLE.'</font>' : '<font color="red">'._SW_UNWRITABLE.'</font>' ?></td>
      </tr><tr>
        <td>/modules/mod_swmenupro/cache</td><td><?php echo is_writable($mosConfig_absolute_path."/modules/mod_swmenupro/cache") ? '<font color="green">'._SW_WRITABLE.'</font>' : '<font color="red">'._SW_UNWRITABLE.'</font>' ?></td>
	  </tr><tr>
		<td>/components/com_swmenupro</td><td><?php echo is_writable($mosConfig_absolute_path."/components/com_swmenupro") ? '<font color="green">'._SW_WRITABLE.'</font>' : '<font color="red">'._SW_UNWRITABLE.'</font>' ?></td>
	  </tr><tr>
		<td>/administrator/components/com_swmenupro</td><td><?php echo is_writable($mosConfig_absolute_path."/administrator/components/com_swmenupro") ? '<font color="green">'._SW_WRITABLE.'</font>' : '<font color="red">'._SW_UNWRITABLE.'</font>' ?>
	  </td></tr>
	  <tr>
		<td>/administrator/components/com_swmenupro/language</td><td><?php echo is_writable($mosConfig_absolute_path."/administrator/components/com_swmenupro/language") ? '<font color="green">'._SW_WRITABLE.'</font>' : '<font color="red">'._SW_UNWRITABLE.'</font>' ?>
	  </td></tr>
	</table>
	</td>
  </tr>
