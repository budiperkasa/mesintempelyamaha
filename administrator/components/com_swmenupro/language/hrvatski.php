...
//Menu Names
define( '_SW_TIGRA_MENU', 'Tigra izbornik' );
define( '_SW_TRANS_MENU', 'Trans izbornik' );
define( '_SW_MYGOSU_MENU', 'MyGosu izbornik' );
define( '_SW_CLICK_MENU', 'Click izbornik' );
define( '_SW_TAB_MENU', 'CSS Tab izbornik' );
define( '_SW_DYN_TAB_MENU', 'Dynamic Tab izbornik' );
define( '_SW_TREE_MENU', 'Tree izbornik' );
...
define( '_SW_MENU_MODULE_MANAGER', 'Manager izbornièkih modula' );
define( '_SW_INDIVIDUAL_ITEM_EDITOR', 'Ureðivaè pojedinih stavki' );
...
//izbornièki modul Manager Page (list izbornièki moduls)
define( '_SW_MENU_MODULES', 'Izbornièki moduli' );
define( '_SW_DISPLAY', 'prikaži' );
define( '_SW_USE_DEFAULT_MODULE', 'Koristiti standardni stil izbornika' );
define( '_SW_COPY_MODULE', 'Kopiranje postojeæeg stila izbornika' );
define( '_SW_CREATE_MODULE', 'Izrada novog izbornièkog modula' );
define( '_SW_MODULE_NAME', 'Ime modula' );
define( '_SW_SELECT_MENU', 'Odabir izbornièkog sustava' );
define( '_SW_SELECT_STYLE', 'Odaberite stil zbornika koji želite kopirati' );
...
define( '_SW_SELECT_ITEM_TIP', 'Odaberite stavku izbornika klikom na ime izbornièke stavke.' );
define( '_SW_EDIT_MODULE_TIP', 'Kliknite ovdje da bi uredili stil i postavke %s izbornièkog modula' );
define( '_SW_COPY_STYLE_TIP', 'Odaberite postojeæi izbornièki modul da biste kopirali postavke stila u novi izbornièki modul' );
define( '_SW_EDIT_CSS_TIP', 'Kolknite ovdje da biste ruèno uredili vanjsku stilsku datoteku za %s izbornièki modul' );
define( '_SW_EXPORT_MODULE_TIP', 'Kliknite ovdje da biste izvezli vanjsku stilsku datoteku za %s izbornièki modul koristeæi trenutne stilske postavke' );
define( '_SW_EDIT_IMAGES_TIP', 'Kliknite ovdje da biste uredili pojedinaène izbornièke stavke, CSS i svojstva za %s izbornièki modul' );
define( '_SW_PREVIEW_MODULE_TIP', 'Kliknite ovdje da biste pregledali %s izbornièki modul u pop-up prozoru' );
define( '_SW_DELETE_MODULE_TIP', 'Kliknite ovdje da biste izbrisali %s izbornièki modul' );
define( '_SW_MENU_SYSTEM_INFO_TIP', '<b>Kliknite ovdje</b> da biste dobili više informacija o razlièitim dostupnim izbornièkim sustavima' );
define( '_SW_MODULE_TIP', '<b>Stil izbornika:</b> %s<br /><b>Izvorni izbornik:</b> %s<br /><b>Pozicija:</b> %s<br /><b>Pristup:</b> %s<br /><b>Objavljeno:</b> %s');
define( '_SW_CREATE_MENU_TIP', 'Kliknite ovdje da biste kreirali novi izbornièki modul.');
define( '_SW_APPLY_TIP', 'Kliknite ovdje da biste primjenili sve promjene u stilovima i modulima u bazu' );
...
define( '_SW_APPLY_BUTTON', 'primjeni' );
define( '_SW_CREATE_BUTTON', 'Izradi novi' );
define( '_SW_EDIT_BUTTON', 'uredi' );
define( '_SW_DELETE_BUTTON', 'izbriši' );
define( '_SW_EDITCSS_BUTTON', 'uredi CSS' );
define( '_SW_GET_IMAGE_BUTTON', 'preuzmi sliku' );
define( '_SW_UPDATE_CSS_BUTTON', 'Obnovi CSS' );
define( '_SW_UPDATE_OVER_CSS_BUTTON', 'Obnovi pomoæu CSS-a' );


//Internal program links
define( '_SW_UPGRADE_LINK', 'Nadogradnja/popravak swMenuPro.' );
...
define( '_SW_RETURN_MANAGER_LINK', 'Povratak u swMenuPro Manager izbornièkih modula' );


//Program Notices
define( '_SW_NO_MODULE_NOTICE', 'Možda æete trebati instalirati modul da bi SWmenuPro radio ispravno.' );
define( '_SW_NO_MENU_NOTICE', 'Molimo odaberite izbornièki sustav s padajuæeg izbornika.' );
define( '_SW_DELETE_MODULE_NOTICE', 'Jeste li sigurni da želite izbrisati ' );
define( '_SW_MAKE_MODULE_NOTICE', 'Molimo izradite izbornièki modul pomoæu funkcije "Izrada novog izbornièkog modula" s desne strane.' );
define( '_SW_MENU_CHANGE_NOTICE', 'Izmjenili ste izvor izbornika za izbornièki modul.  Ova stranica ne može se prikazati sve dok ne primjenite promjene ili vratite natrag na originalni izvor izbornika.' );


//Program Messages
define( '_SW_DELETE_MODULE_MESSAGE', 'Izbornièki modul uspješno je izbrisan' );
define( '_SW_SAVE_MENU_MESSAGE', 'Postavke su uspješno spremljene' );
define( '_SW_SAVE_MENU_CSS_MESSAGE', 'Postavke su spremljene i vanjska CSS dateka je uspješno kreirana' );
define( '_SW_SAVE_CSS_MESSAGE', 'Vanjska CSS datoteka je uspješno spremljena' );
define( '_SW_NO_SAVE_MENU_CSS_MESSAGE', 'Vanjska CSS datoteka nije kreirana.  Provjerite da li je moguæe zapisivanje u mapu modules/mod_swmenupro/styles.' );
...
define( '_SW_MODULE_VERSION', 'Trenutna verzija swMenuPro modula' );
define( '_SW_COMPONENT_VERSION', 'Trenutna verzija swMenuPro komponente' );
define( '_SW_UPLOAD_UPGRADE', 'Upload swMenuPro datoteku nadogradnje/izdanja' );
define( '_SW_UPLOAD_UPGRADE_BUTTON', 'Upload &amp; instalacijske datoteke' );

define( '_SW_COMPONENT_SUCCESS', 'swMenuPro komponenta uspješno nadograðema.' );
define( '_SW_COMPONENT_FAIL', 'Nadogradnja nije moguæa, provjerite da li je moguže zapisivanje u sve mape nabrojene ispod.' );
define( '_SW_INVALID_FILE', 'Èini se da ovo nije ispravna swMenuPro datoteka nadogradnje/izdanja.' );


//////////////////////////
//Item images and CSS page
/////////////////////////
define( '_SW_AUTO_MULTIPLE_LABEL', 'Automatski uredi više izbornièkih stavaka.' );
define( '_SW_AUTO_CSS_CREATOR_LABEL', 'Alat za automatsko kreiranje CSS-a.' );
define( '_SW_PROPERTIES_LABEL', 'Svojstava izbornièke stavke' );

//top tabs
define( '_SW_ITEM_PROPERTIES_TAB', 'Svojstva<br /> Slike' );
define( '_SW_ITEM_CSS_TAB', 'Normalno / Iznad<br /> CSS' );
define( '_SW_MULTIPLE_TAB', 'Konfiguracija <br />više stavki' );

//general text
define( '_SW_STEP_1', 'Korak 1' );
define( '_SW_STEP_2', 'Korak 2' );
define( '_SW_STEP_3', 'Korak 3' );
define( '_SW_SELECTED_ITEM', 'Odabrana izbornièka stavka' );
define( '_SW_NONE_SELECTED', 'Ništa nije odabrano' );
define( '_SW_ITEM_PROPERTIES', 'Svojstva stavki' );
define( '_SW_SHOW_ITEM', 'Prikaži izbornièku stavku' );
define( '_SW_SHOW_ITEM_NAME', 'Prikaži ime izbornièke stavke' );
define( '_SW_IS_LINK', 'Stavka je veza' );
define( '_SW_IMAGE_ALIGN', 'Poravnanje slike' );

//Select box text
define( '_SW_CSS_SELECT', 'Odaberite CSS vrijednost za ureðivanje' );
define( '_SW_COMPLETE_BORDER_SELECT', 'Kompletan rub' );
define( '_SW_BORDER_TOP_SELECT', 'Gornji rub' );
define( '_SW_BORDER_RIGHT_SELECT', 'Desni rub' );
define( '_SW_BORDER_BOTTOM_SELECT', 'Donji rub' );
define( '_SW_BORDER_LEFT_SELECT', 'Lijevi rub' );
define( '_SW_PADDING_SELECT', 'Razmak' );
define( '_SW_MARGIN_SELECT', 'Margine' );
define( '_SW_BACKGROUND_SELECT', 'Pozadina' );
define( '_SW_TEXT_SELECT', 'Tekst' );
define( '_SW_FONT_SELECT', 'Font' );
define( '_SW_OFFSET_SELECT', 'Offseti' );
define( '_SW_DIMENSION_SELECT', 'Dimenzije' );
define( '_SW_EFFECT_SELECT', 'Specijalni efekti' );

define( '_SW_AUTO_SELECT', 'Odabrane izbornièke stavke  ' );
define( '_SW_AUTO_ALL_SELECT', 'Sve izbornièke stavke' );
define( '_SW_AUTO_TOP_SELECT', 'Gornje izbornièke stavke' );
define( '_SW_AUTO_SUB_SELECT', 'Podizbornièke stavke' );
define( '_SW_AUTO_FOLDER_SELECT', 'Izbornièke stavke mape' );
define( '_SW_AUTO_DOCUMENT_SELECT', 'Izbornièke stavke dokumenta' );

define( '_SW_ATTRIBUTE_SELECT', 'Odaberite atribute koje ureðujete' );
define( '_SW_ATTRIBUTE_IMAGE_SELECT', 'Normalna slika' );
define( '_SW_ATTRIBUTE_OVER_IMAGE_SELECT', 'Mouse Over slika' );
define( '_SW_ATTRIBUTE_SHOW_NAME_SELECT', 'Prikaži ime stavke' );
define( '_SW_ATTRIBUTE_DONT_SHOW_NAME_SELECT', 'Ne prikazuj ime stavke' );
define( '_SW_ATTRIBUTE_IS_LINK_SELECT', 'Stavka je Veza' );
define( '_SW_ATTRIBUTE_IS_NOT_LINK_SELECT', 'Stavka nije Veza' );
define( '_SW_ATTRIBUTE_SHOW_ITEM_SELECT', 'Prikaži stavku izbrnika' );
define( '_SW_ATTRIBUTE_DONT_SHOW_ITEM_SELECT', 'Ne prikazuj stavku izbornika' );
define( '_SW_ATTRIBUTE_IMAGE_LEFT_SELECT', 'Lijevo poravnanje slike' );
define( '_SW_ATTRIBUTE_IMAGE_RIGHT_SELECT', 'Desno poravnanje slike' );
define( '_SW_ATTRIBUTE_CSS_SELECT', 'Normalni CSS' );
...
define( '_SW_IMAGE', 'Slika' );
define( '_SW_IMAGE_OVER', 'Mouse Over slika' );
define( '_SW_PREVIEW', 'Pregled' );
define( '_SW_IMAGE_URL', 'URL Slike' );
define( '_SW_HSPACE', 'H Space' );
define( '_SW_VSPACE', 'V Space' );
define( '_SW_REPEAT', 'Ponavljanje' );
define( '_SW_TEXT_DECORATION', 'Dekoracija' );
define( '_SW_TEXT_TRANSFORM', 'Transformacija' );
define( '_SW_TEXT_INDENT', 'Uvlaka (Indent)' );
define( '_SW_WHITE_SPACE', 'Prazan prostor (White Space)' );
define( '_SW_FONT_STYLE', 'Stil fonta' );

//tool tips
define( '_SW_STEP_1_TIP', 'Odaberite grupu izbornièkih stavki na koje æe se primjeniti promjene.' );
define( '_SW_STEP_2_TIP', 'Odaberite atribute koje želite izmjeniti.' );
define( '_SW_STEP_3_TIP', 'Kliknite "primjeni" da biste primjenili odabrane atribute na izbornièke stavke.' );
...
define( '_SW_CLICK_DIMENSIONS_LABEL', 'Dimenzije Click izbornika' );
define( '_SW_COMPLETE_PADDING_LABEL', 'Pomak cijelog izbornika' );
...
define( '_SW_TAB_MARGIN', 'Margina izmeðu tabova' );
...
define( '_SW_OVER_BORDER', '"Iznad" Border' );
...
//tab menus
define( '_SW_TAB_ACTIVE', 'Aktivni tab' );
define( '_SW_TAB_TOP', 'Tab gornjeg izbornika' );
define( '_SW_DIVIDER_COLOR', 'Boja razdjeljnika' );

//tree menu
define( '_SW_ICONS_LABEL', 'Ikone izbornika' );
define( '_SW_ICON_TOP', 'Ikona vrha(Top)' );
define( '_SW_ICON_FOLDER', 'Ikona mape' );
define( '_SW_ICON_FOLDER_OPEN', 'Ikona otvorene mape' );
define( '_SW_ICON_DOCUMENT', 'Ikona dokumenta' );
...
define( '_SW_OVER_BORDER_COLOR', '- "iznad" boja ruba' );
...
define( '_SW_IMAGES_CSS_TAB', 'Slike & CSS stavki' );
define( '_SW_TREE_SIZE_TAB', 'Velièina & ostale postavke' );
