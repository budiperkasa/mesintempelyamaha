...
//Новые термины swMenuPro 5.0

define( '_SW_SLIDECLICK_MENU', 'Accordian Menu' );
define( '_SW_AUTO_CLOSE_LABEL', 'Автоматически закрывать открытые подменю?' );
define( '_SW_UPGRADE_VERSIONS', 'Текущая установленная версия swMenuPro' );
...
define( '_SW_UPLOAD_LANGUAGE_HEADING', 'Загрузка нового языкового файла' );
define( '_SW_LANGUAGE_UPLOAD_BUTTON', 'Загрузить языковой файл' );
define( '_SW_FILE_PERMISSIONS', 'Текущие разрешения на запись' );
define( '_SW_LANGUAGE_SUCCESS', 'Новый языковой файл swMenuPro успешно добавлен.' );
...
//Имена страниц
define( '_SW_MENU_MODULE_MANAGER', 'Менеджер модулей меню' );
define( '_SW_MANUAL_CSS_EDITOR', 'Ручной редактор CSS' );
define( '_SW_INDIVIDUAL_ITEM_EDITOR', 'Редактор индивидуальных элементов' );
...
//Страница менеджера модулей меню (список модулей меню)
define( '_SW_MENU_MODULES', 'Модули меню' );
define( '_SW_DISPLAY', 'Число отображаемых модулей' );
define( '_SW_USE_DEFAULT_MODULE', 'Использовать стиль по умолчанию' );
define( '_SW_COPY_MODULE', 'Копировать существующий стиль' );
define( '_SW_CREATE_MODULE', 'Создание нового модуля меню' );
define( '_SW_MODULE_NAME', 'Имя модуля' );
define( '_SW_SELECT_MENU', 'Выберите систему меню' );
define( '_SW_SELECT_STYLE', 'Выберите стиль меню' );


//Подсказки
define( '_SW_SELECT_ITEM_TIP', 'Выберите элемент меню, щелкнув по его имени.' );
define( '_SW_EDIT_MODULE_TIP', 'Нажмите здесь, чтобы отредактировать стиль и параметры модуля меню %s' );
define( '_SW_COPY_STYLE_TIP', 'Выберите существующий модуль меню, чтобы скопировать параметры стиля к новому модулю меню' );
define( '_SW_EDIT_CSS_TIP', 'Нажмите здесь, чтобы вручную отредактировать внешнюю таблицу стилей для модуля меню %s' );
define( '_SW_EXPORT_MODULE_TIP', 'Нажмите здесь, чтобы экспортировать внешнюю таблицу стилей для модуля меню %s, используя текущие параметры стиля' );
define( '_SW_EDIT_IMAGES_TIP', 'Нажмите здесь, чтобы отредактировать индивидуальные изображения пункта меню, CSS и свойства для модуля меню %s' );
define( '_SW_PREVIEW_MODULE_TIP', 'Нажмите здесь, чтобы просмотреть модуль меню %s во всплывающем окне' );
define( '_SW_DELETE_MODULE_TIP', 'Нажмите здесь, чтобы удалить модуль меню %s' );
define( '_SW_MENU_SYSTEM_INFO_TIP', '<b>Нажмите здесь</b>, чтобы получить информацию о различных доступных системах меню' );
define( '_SW_MODULE_TIP', '<b>Стиль меню:</b> %s<br /><b>Источнк меню:</b> %s<br /><b>Положение:</b> %s<br /><b>Доступ:</b> %s<br /><b>Опубликовано:</b> %s');
define( '_SW_CREATE_MENU_TIP', 'Нажмите здесь, чтобы создать новый модуль меню.');

define( '_SW_SAVE_TIP', 'Нажмите здесь, чтобы сохранить все изменения стиля и модуля в базе данных' );
define( '_SW_APPLY_TIP', 'Нажмите здесь, чтобы применить все изменения стиля и модуля к базе данных' );
...
define( '_SW_APPLY_BUTTON', 'применить' );
define( '_SW_CANCEL_BUTTON', 'отмена' );
define( '_SW_PREVIEW_BUTTON', 'просмотр' );
define( '_SW_EXPORT_BUTTON', 'экспорт' );
define( '_SW_CREATE_BUTTON', 'Создать сейчас' );
define( '_SW_EDIT_BUTTON', 'правка' );
define( '_SW_DELETE_BUTTON', 'удалить' );
define( '_SW_EDITCSS_BUTTON', 'правка CSS' );
define( '_SW_GET_IMAGE_BUTTON', 'получить рисунок' );
define( '_SW_UPDATE_CSS_BUTTON', 'Обновить CSS' );
define( '_SW_UPLOAD_BUTTON', 'Загрузить файл' );
define( '_SW_UPDATE_OVER_CSS_BUTTON', 'Обновить CSS замены' );


//Внутренние ссылки программы
define( '_SW_UPGRADE_LINK', 'Обновление/Восстановление swMenuPro.' );
...
define( '_SW_RETURN_MANAGER_LINK', 'Возврат к менеджеру модулей swMenuPro' );


//Программные уведомления
define( '_SW_NO_MODULE_NOTICE', 'Вам также нужно установить модуль для SWmenuPro для правильной работы.' );
define( '_SW_NO_MENU_NOTICE', 'Пожалуйста, выберите систему меню из выпадающего списка.' );
define( '_SW_DELETE_MODULE_NOTICE', 'Вы действительно хотите удалить ' );
define( '_SW_MAKE_MODULE_NOTICE', 'Пожалуйста, создайте модуль меню с помощью модуля создания нового меню справа.' );
define( '_SW_UPLOAD_FILE_NOTICE', 'Пожалуйста, выберите файл для загрузки.' );
define( '_SW_MENU_CHANGE_NOTICE', 'Вы изменили источник меню для модуля.  Эта страница не может быть отображена, пока вы не примените изменения или не вернетесь к оригинальному источнику меню.' );


//Программные сообщения
define( '_SW_DELETE_MODULE_MESSAGE', 'Модуль меню успешно удален' );
...
define( '_SW_NO_SAVE_MENU_CSS_MESSAGE', 'Внешний CSS файл не создан.  Убедитесь, что папка modules/mod_swmenupro/styles  доступна для записи.' );
...
define( '_SW_MODULE_VERSION', 'Текущая версия модуля swMenuPro' );
define( '_SW_COMPONENT_VERSION', 'Текущая версия компонента swMenuPro' );
define( '_SW_UPLOAD_UPGRADE', 'Загрузка файла обновления/выпуска swMenuPro' );
define( '_SW_UPLOAD_UPGRADE_BUTTON', 'Загрузить и установить файл' );

define( '_SW_COMPONENT_SUCCESS', 'Компонент swMenuPro успешно обновлен.' );
define( '_SW_COMPONENT_FAIL', 'Обновление невозможно. Пожалуйста, убедитесь, что все нижеуказанные папки доступны для записи.' );
define( '_SW_INVALID_FILE', 'Этот файл не является правильным пакетом обновления/установки swMenuPro.' );



//////////////////////////
//Страница изображений и CSS
/////////////////////////
define( '_SW_AUTO_MULTIPLE_LABEL', 'Редактирование нескольких пунктов меню.' );
define( '_SW_AUTO_CSS_CREATOR_LABEL', 'Утилита автоматического создания CSS' );
define( '_SW_PROPERTIES_LABEL', 'Свойства элемента меню' );

//Верхние вкладки
define( '_SW_ITEM_PROPERTIES_TAB', 'Свойства<br />изображений' );
define( '_SW_ITEM_CSS_TAB', 'CSS обычный / замена' );
define( '_SW_MULTIPLE_TAB', 'Несколько<br />пунктов меню' );

//Общий текст
define( '_SW_STEP_1', 'Шаг 1' );
define( '_SW_STEP_2', 'Шаг 2' );
define( '_SW_STEP_3', 'Шаг 3' );
define( '_SW_SELECTED_ITEM', 'Выбран пункт меню' );
define( '_SW_NONE_SELECTED', 'Ничего не выбрано' );
define( '_SW_ITEM_PROPERTIES', 'Свойства элемента' );
define( '_SW_SHOW_ITEM', 'Показывать пункт меню' );
define( '_SW_SHOW_ITEM_NAME', 'Показывать имя пункта меню' );
define( '_SW_IS_LINK', 'Пункт как ссылка' );
define( '_SW_IMAGE_ALIGN', 'Выравнивание изображения' );

//Текст списков выбора
define( '_SW_CSS_SELECT', 'Выберите значение CSS для правки' );
define( '_SW_COMPLETE_BORDER_SELECT', 'Общая граница' );
define( '_SW_BORDER_TOP_SELECT', 'Верхняя граница' );
define( '_SW_BORDER_RIGHT_SELECT', 'Правая граница' );
define( '_SW_BORDER_BOTTOM_SELECT', 'Нижняя граница' );
define( '_SW_BORDER_LEFT_SELECT', 'Левая граница' );
define( '_SW_PADDING_SELECT', 'Отступы' );
define( '_SW_MARGIN_SELECT', 'Поля' );
define( '_SW_BACKGROUND_SELECT', 'Фон' );
define( '_SW_TEXT_SELECT', 'Текст' );
define( '_SW_FONT_SELECT', 'Шрифт' );
define( '_SW_OFFSET_SELECT', 'Смещения' );
define( '_SW_DIMENSION_SELECT', 'Размеры' );
define( '_SW_EFFECT_SELECT', 'Специальные эффекты' );

define( '_SW_AUTO_SELECT', 'Выбранные пункты меню ' );
define( '_SW_AUTO_ALL_SELECT', 'Все пункты меню' );
define( '_SW_AUTO_TOP_SELECT', 'Пункты меню верхнего уровня' );
define( '_SW_AUTO_SUB_SELECT', 'Пункты подменю' );
define( '_SW_AUTO_FOLDER_SELECT', 'Пункты меню папок' );
define( '_SW_AUTO_DOCUMENT_SELECT', 'Пункты меню документов' );

define( '_SW_ATTRIBUTE_SELECT', 'Выберите атрибуты для правки' );
define( '_SW_ATTRIBUTE_IMAGE_SELECT', 'Обычное изображение' );
define( '_SW_ATTRIBUTE_OVER_IMAGE_SELECT', 'Изображение при наведении мыши' );
define( '_SW_ATTRIBUTE_SHOW_NAME_SELECT', 'Показывать имя элемента' );
define( '_SW_ATTRIBUTE_DONT_SHOW_NAME_SELECT', 'Не показывать имя элемента' );
define( '_SW_ATTRIBUTE_IS_LINK_SELECT', 'Элемент является ссылкой' );
define( '_SW_ATTRIBUTE_IS_NOT_LINK_SELECT', 'Элемент не является ссылкой' );
define( '_SW_ATTRIBUTE_SHOW_ITEM_SELECT', 'Показывать пункт меню' );
define( '_SW_ATTRIBUTE_DONT_SHOW_ITEM_SELECT', 'Не показывать пункт меню' );
define( '_SW_ATTRIBUTE_IMAGE_LEFT_SELECT', 'Изображение по левому краю' );
define( '_SW_ATTRIBUTE_IMAGE_RIGHT_SELECT', 'Изображение по правому краю' );
define( '_SW_ATTRIBUTE_CSS_SELECT', 'Обычный CSS' );
define( '_SW_ATTRIBUTE_OVER_CSS_SELECT', 'CSS замены (при наведении мыши)' );


//Текст экстра CSS
define( '_SW_CSS', 'CSS' );
define( '_SW_CSS_OVER', 'CSS замены (при наведении мыши)' );
define( '_SW_IMAGE', 'Рисунок' );
define( '_SW_IMAGE_OVER', 'Рисунок при наведении' );
define( '_SW_PREVIEW', '- Предпросмотр' );
define( '_SW_IMAGE_URL', 'URL рисунка' );
define( '_SW_HSPACE', 'H-пространство' );
define( '_SW_VSPACE', 'V-пространство' );
define( '_SW_REPEAT', 'Повтор' );
define( '_SW_TEXT_DECORATION', 'Декорация' );
define( '_SW_TEXT_TRANSFORM', 'Трансформация' );
define( '_SW_TEXT_INDENT', 'Отступ' );
define( '_SW_WHITE_SPACE', 'Незаполненное пространство' );
define( '_SW_FONT_STYLE', 'Стиль шрифта' );

//Подсказки
define( '_SW_STEP_1_TIP', 'Выбор группы пунктов меню для применения изменений.' );
define( '_SW_STEP_2_TIP', 'Выбор атрибутов, которые вы хотите изменить.' );
define( '_SW_STEP_3_TIP', 'Нажмите для применения выбранных атрибутов к пунктам меню.' );
...
define( '_SW_CLICK_DIMENSIONS_LABEL', 'Размеры Click Menu' );
...
define( '_SW_COMPLETE_PADDING_LABEL', 'Общие отступы меню' );

//Древовидное меню
define( '_SW_OTHER_SETTINGS_LABEL', 'Другие параметры' );
define( '_SW_TREE_WIDTH_LABEL', 'Ширина меню' );
define( '_SW_FOLDER_LINKS', 'Папки являются ссылками?' );
define( '_SW_USE_LINES', 'Использовать линии?' );
define( '_SW_USE_ICONS', 'Использовать иконки?' );
...
define( '_SW_TAB_MARGIN', 'Поле между вкладками' );
...
define( '_SW_OVER_BORDER', '- Граница при наведении' );
...
//Меню вкладками
define( '_SW_TAB_ACTIVE', 'Активная вкладка' );
define( '_SW_TAB_TOP', 'Вкладка меню' );
define( '_SW_DIVIDER_COLOR', '- Цвет разделителя' );

//Древовидное меню
define( '_SW_ICONS_LABEL', 'Иконки меню' );
define( '_SW_ICON_TOP', 'Верхняя иконка' );
define( '_SW_ICON_FOLDER', 'Иконка папки' );
define( '_SW_ICON_FOLDER_OPEN', 'Иконка открытой папки' );
define( '_SW_ICON_DOCUMENT', 'Иконка документа' );
...
define( '_SW_OVER_BORDER_COLOR', '- Цвет границы при наведении' );
...
define( '_SW_IMAGES_CSS_TAB', 'Изображения и CSS' );
define( '_SW_TREE_SIZE_TAB', 'Размер и другие параметры' );
