...
define( '_SW_DISPLAY', 'display' );
define( '_SW_USE_DEFAULT_MODULE', 'Use default menu style' );
define( '_SW_COPY_MODULE', 'Copy existing menu style' );
define( '_SW_CREATE_MODULE', 'Create New Menu Module' );
define( '_SW_MODULE_NAME', 'Module Name' );
define( '_SW_SELECT_MENU', 'Select Menu System' );
define( '_SW_SELECT_STYLE', 'Select Menu Style to Copy' );


//Tool Tips
define( '_SW_SELECT_ITEM_TIP', 'Select menu item by clicking on menu item name.' );
define( '_SW_EDIT_MODULE_TIP', 'Click here to edit the style and settings of the %s menu module' );
define( '_SW_COPY_STYLE_TIP', 'Select an existing menu module to copy style settings to new a menu module' );
define( '_SW_EDIT_CSS_TIP', 'Click here to manually edit the external style sheet for the %s menu module' );
...
define( '_SW_CREATE_MENU_TIP', 'Click here to create your new menu module.');

define( '_SW_SAVE_TIP', 'Click here to save all style and module changes to the database' );
define( '_SW_APPLY_TIP', 'Click here to apply all style and module changes to the database' );
...
define( '_SW_APPLY_BUTTON', 'apply' );
define( '_SW_CANCEL_BUTTON', 'cancel' );
define( '_SW_PREVIEW_BUTTON', 'preview' );
define( '_SW_EXPORT_BUTTON', 'export' );
define( '_SW_CREATE_BUTTON', 'Create Now' );
define( '_SW_EDIT_BUTTON', 'edit' );
define( '_SW_DELETE_BUTTON', 'delete' );
...
define( '_SW_UPGRADE_LINK', 'Upgrade/Repair swMenuPro.' );
...
define( '_SW_RETURN_MANAGER_LINK', 'Return to swMenuPro Menu Module Manager' );


//Program Notices
define( '_SW_NO_MODULE_NOTICE', 'You also need to install the module for SWmenuPro to properly work.' );
define( '_SW_NO_MENU_NOTICE', 'Please select a menu system from the drop down list.' );
define( '_SW_DELETE_MODULE_NOTICE', 'Are you sure you want to delete ' );
define( '_SW_MAKE_MODULE_NOTICE', 'Please Create a menu module with the Create new menu module facility on the right side.' );
define( '_SW_UPLOAD_FILE_NOTICE', 'Please select a file to upload.' );
define( '_SW_MENU_CHANGE_NOTICE', 'You have changed the menu source for the menu module.  This page can not display until you have applied the changes or reverted back to the original menu source.' );


//Program Messages
define( '_SW_DELETE_MODULE_MESSAGE', 'Menu module sucessfully deleted' );
...
define( '_SW_NO_SAVE_MENU_CSS_MESSAGE', 'External CSS file not created.  Make sure your modules/mod_swmenupro/styles folder is writable.' );
...
define( '_SW_MODULE_VERSION', 'Current swMenuPro Module Version' );
define( '_SW_COMPONENT_VERSION', 'Current swMenuPro Component Version' );
define( '_SW_UPLOAD_UPGRADE', 'Upload swMenuPro Upgrade/Release File' );
define( '_SW_UPLOAD_UPGRADE_BUTTON', 'Upload & Install File' );

define( '_SW_COMPONENT_SUCCESS', 'Succesfully upgraded swMenuPro Component.' );
...
//general text
define( '_SW_STEP_1', 'Step 1' );
define( '_SW_STEP_2', 'Step 2' );
define( '_SW_STEP_3', 'Step 3' );
define( '_SW_SELECTED_ITEM', 'Selected Menu Item' );
define( '_SW_NONE_SELECTED', 'None Selected' );
define( '_SW_ITEM_PROPERTIES', 'Item Properties' );
define( '_SW_SHOW_ITEM', 'Show Menu Item' );
define( '_SW_SHOW_ITEM_NAME', 'Show Menu Item Name' );
define( '_SW_IS_LINK', 'Item is a Link' );
define( '_SW_IMAGE_ALIGN', 'Image Align' );
...
define( '_SW_AUTO_SELECT', 'Selected Menu Items ' );
define( '_SW_AUTO_ALL_SELECT', 'All Menu Items' );
...
define( '_SW_ATTRIBUTE_SELECT', 'Select Attribute to Edit' );
define( '_SW_ATTRIBUTE_IMAGE_SELECT', 'Normal Image' );
define( '_SW_ATTRIBUTE_OVER_IMAGE_SELECT', 'Mouse Over Image' );
define( '_SW_ATTRIBUTE_SHOW_NAME_SELECT', 'Show Item Name' );
define( '_SW_ATTRIBUTE_DONT_SHOW_NAME_SELECT', 'Don\'t Show Item Name' );
define( '_SW_ATTRIBUTE_IS_LINK_SELECT', 'Item is a Link' );
define( '_SW_ATTRIBUTE_IS_NOT_LINK_SELECT', 'Item is not a Link' );
define( '_SW_ATTRIBUTE_SHOW_ITEM_SELECT', 'Show Menu Item' );
define( '_SW_ATTRIBUTE_DONT_SHOW_ITEM_SELECT', 'Dont\'t Show Menu Item' );
define( '_SW_ATTRIBUTE_IMAGE_LEFT_SELECT', 'Image Align Left' );
define( '_SW_ATTRIBUTE_IMAGE_RIGHT_SELECT', 'Image Align Right' );
...
//tool tips
define( '_SW_STEP_1_TIP', 'Select group of menu items to apply changes to.' );
define( '_SW_STEP_2_TIP', 'Select the attribute you want to change.' );
define( '_SW_STEP_3_TIP', 'Press apply to apply the selected attributes to the menu items.' );
...
define( '_SW_IMAGES_CSS_TAB', 'Item Images & CSS' );
define( '_SW_TREE_SIZE_TAB', 'Size & Other Settings' );
