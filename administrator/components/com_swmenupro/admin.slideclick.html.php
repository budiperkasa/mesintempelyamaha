...
<table width="750">
  ...
  <td valign="top"> 
    <table width="360" style="border:0px solid #cccccc;height:260px;" >
      ...
      <td width="120"> <div align="right">
          <input  name="sub_border_color_over" type="text" onChange="doAccordSubBorder();" id="sub_border_color_over" value="<?php echo $subborderover[2];?>" size="8"/>
        ...
        <td valign="top" align="center">
          <table width="360" height="130" style="border:0px solid #cccccc;">
            ...
            <tr class="swmenu_menubackgr">
              ...
              <td width="120"><div align="right">
                  <input id="sub_border_over_width" onchange="doAccordSubBorder();" name="sub_border_over_width" type="text" value="<?php echo $subborderover[0]; ?>" size="8" /> px
                </div>
              </td>
            </tr><tr>
