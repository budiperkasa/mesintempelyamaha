...
require_once($mosConfig_absolute_path."/administrator/components/com_swmenupro/ImageManager/config.inc.php");
require_once($mosConfig_absolute_path."/administrator/components/com_swmenupro/ImageManager/Classes/ImageManager.php");
...
function drawFiles($list, &$manager)
{
	...
	{ ?>
		...
		<a href="javascript:;" onclick="selectImage('<?php echo $file['relative'];?>', '<?php echo $entry; ?>', <?php echo $file['image'][0];?>, <?php echo $file['image'][1]; ?>);"title="<?php echo $entry; ?> - <?php echo Files::formatSize($file['stat']['size']); ?>"><img src="<?php echo $manager->getThumbnail($file['relative']); ?>" border="0" alt="<?php echo $entry; ?> - <?php echo Files::formatSize($file['stat']['size']); ?>"/></a>
			...
			<a href="index3.php?option=com_swmenupro&task=imageFiles&dir=<?php echo $relative; ?>&amp;delf=<?php echo rawurlencode($file['relative']);?>" title="Trash" onclick="return confirmDeleteFile('<?php echo $entry; ?>');"><img src="components/com_swmenupro/ImageManager/img/edit_trash.gif" height="15" width="15" border="0" alt="Trash"/></a><a href="javascript:;" title="Edit" onclick="editImage('<?php echo rawurlencode($file['relative']);?>');"><img src="components/com_swmenupro/ImageManager/img/edit_pencil.gif" border="0" height="15" width="15" alt="Edit"/></a>
...
function drawDirs($list, &$manager) 
{
	...
	{ ?>
		<td><table width="100" cellpadding="0" cellspacing="0"><tr><td class="block">
		<a href="index3.php?option=com_swmenupro&task=imageFiles&dir=<?php echo rawurlencode($path); ?>" onclick="updateDir('<?php echo $path; ?>')" title="<?php echo $dir['entry']; ?>"><img src="components/com_swmenupro/ImageManager/img/folder.gif" border="0" height="80" width="80" alt="<?php echo $dir['entry']; ?>" /></a>
		</td></tr><tr>
		<td class="edit">
			<a href="index3.php?option=com_swmenupro&task=imageFiles&dir=<?php echo $relative; ?>&amp;deld=<?php echo rawurlencode($path); ?>" title="Trash" onclick="return confirmDeleteDir('<?php echo $dir['entry']; ?>', <?php echo $dir['count']; ?>);"><img src="components/com_swmenupro/ImageManager/img/edit_trash.gif" border="0" height="15" width="15" alt="Trash"/></a>
			<?php echo $dir['entry']; ?>
		</td>
		</tr></table></td>
	  <?php 
...
<head>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<link href="components/com_swmenupro/ImageManager/assets/imagelist.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="components/com_swmenupro/ImageManager/assets/images.js"></script>
</head>
