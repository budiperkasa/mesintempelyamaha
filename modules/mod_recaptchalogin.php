<?php
/**
* @version mod_recaptchalogin.php
* @package Joomla
...
*
* D20070820 - v0.0.2 -  modified to forward to reCAPTCHA registration
* D20070822 - v0.0.3 - now based on Joomla 1.0.13 core files, thus eliminating the potential XSS problem
*/
...
// ie HTML when not logged in and trying to login
	...
	<tr>
		<td>
			<a href="<?php echo sefRelToAbs( 'index.php?option=com_recaptcha&amp;task=lostPassword' ); ?>">
	...
	if ( $registration_enabled ) {
		...
		<tr>
			<td>
				...
				<a href="<?php echo sefRelToAbs( 'index.php?option=com_recaptcha&amp;task=register' ); ?>">
