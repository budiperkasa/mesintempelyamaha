...
// saved at: 2008-11-17 10:59:07
// by: khoiruddin (id: 67 )
// domain: http://outboardmotoryamaha.com

if (!defined('_VALID_MOS')) die('Direct Access to this location is not allowed.');

$version = "1.3.8 - build_337 - Joomla - <a href=\"http://extensions.siliana.com/\">extensions.Siliana.com</a>";
$Enabled = "1";
$replacement = "-";
$pagerep = "-";
$stripthese = ",|~|!|@|%|^|(|)|<|>|:|;|{|}|[|]|&|`|&#8222;|&#8249;|&#8217;|&#8216;|&#8220;|&#8221;|&#8226;|&#8250;|«|´|»|°";
...
$shContentTableName = "outboard-motor-yamaha";
$shAutoRedirectWww = "1";
...
$defaultComponentStringList = array("contact"=>"","extplorer"=>"","jce"=>"","joomlapack"=>"","login"=>"","newsfeeds"=>"","poll"=>"","search"=>"","weblinks"=>"","xmap"=>"");
...
$defaultComponentItemidList = array("contact"=>"","extplorer"=>"","jce"=>"","joomlapack"=>"","login"=>"","newsfeeds"=>"","poll"=>"","search"=>"","weblinks"=>"","xmap"=>"");
$UseDefaultItemids = "1";
