...
$helpurl = strval( $params->get( 'help_url', 'http://www.joomlacontenteditor.net' ) );
...
$fullhelpurl = $helpurl . '/index.php?option=com_content&amp;view=article&amp;tmpl=comeponent&amp;task=findkey&amp;lang=' . $lang . '&amp;keyref=';
?>
