...
DEFINE('_ON_NEW_CONTENT', "A new Content Item has been submitted by [
%s ] titled [ %s ] from Section [ %s ] and Category [ %s ]" );
...
DEFINE('_EMAIL_DESCRIPTION','* Send an e-mail *');
...
DEFINE('_REGWARN_EMAIL_INUSE', 'This e-mail is already registered. If
you forgot the password click on "Lost your Password" and a new
...
DEFINE('_REG_COMPLETE_NOPASS','<div
class="componentheading">Registration Complete!</div><br
/>&nbsp;&nbsp;'
...
DEFINE('_REG_COMPLETE_ACTIVATE', '<div
class="componentheading">Registration Complete!</div><br
/>Your account has been created and activation link has been sent to
the e-mail address you entered. Note that you must activate the account
by clicking on the activation link when you get the e-mail before you
can login.');

DEFINE('_REG_ACTIVATE_COMPLETE', '<div
class="componentheading">Activation Complete!</div><br
/>Your account has been successfully activated. You can now login
using the username and password you chose during the registration.');

DEFINE('_REG_ACTIVATE_NOT_FOUND', '<div
class="componentheading">Invalid Activation Link!</div><br
/>There is no such account in our database or the account has
already been activated.');

DEFINE('_REG_ACTIVATE_FAILURE', '<div
class="componentheading">Activation Failed!</div><br
/>The system was unable to activate your account, please contact the
site administrator.');
...
DEFINE('_SUBMIT_SUCCESS_DESC','Your item has been successfully
submitted to our administrators. It will be reviewed before being
...
/** whos_online.php %s guest||%s guests||online||No Users Online||%s member||%s members*/
...
DEFINE('_GUESTS_COUNT','');

DEFINE('_MEMBER_COUNT','');

DEFINE('_MEMBERS_COUNT','');
