...
function mosShowHead() {
	...
	$mainframe->addMetaTag( 'robots', 'index, follow' );
        $mainframe->addMetaTag( 'Author', 'GARMIN INDONESIA' );
        $mainframe->addMetaTag( 'Copyleft', 'OpenSource-Matter' );
        $mainframe->addMetaTag( 'revisit-after', '1 days' );
        $mainframe->addMetaTag( 'verify-v1', 'goH9qN84wHhAxDHQbxw+aIrku9itiW0e2yqFw8tx7WQ=' );
